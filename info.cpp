...
std::vector<Contributor> const& translations::contributors()
{
    ...
    static std::vector<Contributor> contributors = {
        ...
        },
        {
            .name = "yuki 友樹",
            .github_name = "xiiyuki",
            .codeberg_name = "xii_yuki",
            .link_to_github = true,
            .translated_languages = {"pl"},
        },
        {
            .name = "Nikolaus Delrow",
            .github_name = "koolych",
            .codeberg_name = "koolych",
            .link_to_github = true,
            .translated_languages = {"ru","sah"},
        },
        {
            .name = "Marko XCX",
            .github_name = "markoxcx",
            .codeberg_name = "markoxcx",
            .link_to_github = true,
            .translated_languages = {"sr"},
        },
    };
    return contributors;
}
